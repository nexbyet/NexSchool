...
(function() {
        ...
        stmtSearchTimeout = setTimeout(function() {
            ...
            .then(function(data) {
                ...
                for (var i = 0; i < students.length; i++) {
                    ...
                    html += '<span class="text-xs text-gray-400 font-mono">' + (s.gr_number || '') + ' ' + (s.mobile || '') + '</span>';
                    html += '</div>';
                }
    ...
    var loadStatement = function() {
        ...
        .then(function(data) {
            ...
            html += '<div><h4 class="font-semibold text-gray-900">' + (student.full_name_gu || student.full_name_en || '') + '</h4><p class="text-sm text-gray-500">GR: ' + (student.gr_number || '') + (student.mobile ? ' | મોબાઇલ: ' + student.mobile : '') + '</p></div>';
            html += '</div></div>';
