...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .school-logo { max-height: 50px; margin-bottom: 4px; }
    .school-name { font-size: 14pt; font-weight: 700; }
    .school-address { font-size: 8pt; color: #4b5563; }
    .report-title { font-size: 11pt; font-weight: 600; margin: 6px 0; text-align: center; }
    .report-subtitle { font-size: 8pt; color: #6b7280; text-align: center; margin-bottom: 8px; }
    .report-std-class { font-size: 8pt; text-align: center; margin-bottom: 6px; }
    table { width: 100%; border-collapse: collapse; font-size: 8pt; }
    thead th { background: transparent; color: #000; padding: 5px 4px; font-weight: 600; text-align: center; border: 1px solid #000; font-size: 7.5pt; }
    tbody td { padding: 4px; border: 1px solid #000; text-align: center; vertical-align: middle; }
    .sr-col { width: 30px; }
    .footer { margin-top: 20px; display: flex; justify-content: space-between; font-size: 8pt; color: #4b5563; padding: 0 20px; }
    .footer .sign-line { display: inline-block; width: 150px; border-top: 1px solid #000; padding-top: 3px; text-align: center; font-size: 7pt; }
</style>
</head>
<body>
